...
import {PlusIcon, ServerIcon} from "@heroicons/react/solid";

const GatewayEmpty = ({onAddGateway, ...props}) => {
  return (
    <div className="text-center">
      <ServerIcon className="mx-auto h-12 w-12 text-gray-400" aria-hidden="true" />
